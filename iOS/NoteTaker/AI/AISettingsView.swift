...
struct AISettingsView: View {
    ...
    @FocusState private var focusedInput: AISettingsInput?
        ...
        .toolbar {
            ToolbarItemGroup(placement: .keyboard) {
                ...
                Button(String(localized: "Done")) { focusedInput = nil }
                    .accessibilityIdentifier("hide-ai-keyboard")
            }
        }
#endif
    }
    ...
    private var localAICard: some View {
        SettingsCard {
            ...
            Text(String(localized: "Requires iOS 26 on iPhone 15 Pro, iPhone 15 Pro Max, or iPhone 16 and later; Apple Intelligence enabled; the system model downloaded; and on-device speech recognition permission."))
                .font(.callout)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
    ...
    private var modelCard: some View {
        SettingsCard {
            ...
            ModelChooser(
                ...
                focusedInput: $focusedInput,
                focusInput: .transcriptionSearch
            )
