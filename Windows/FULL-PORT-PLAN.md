...
| 영구 삭제·30일 삭제 보관·오디오 내보내기 | upstream 대조에서 누락 확인, 구현 필요 | Apple LibraryStore/LibraryController의 기기 로컬 purge 표식과 삭제 메타데이터 보존, 원격 복원/재다운로드 호환, 확인 창과 데이터 정리, 저장된 오디오 복사 내보내기. [단계 13](docs/implementation/FULL-PORT-STEP13.md) |
