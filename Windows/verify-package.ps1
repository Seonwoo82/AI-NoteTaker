...
$result = [pscustomobject]@{
    ...
    Scope='Fresh extraction and native WPF/model flows using provided files; no microphone capture. Models are outside ZIP. Sync/share server round trips are verified separately.'
}
