...
- Mac/iOS 1.4.0 빌드 12를 두 기기에 설치하고 실행을 확인했습니다. 실제 iPhone 목소리 등록은 사용자 확인을 기다립니다. 개인 목소리 등록 데이터는 전송하거나 대신 녹음하지 않았습니다. 자세한 내용은 [목소리 등록 검증 기록](docs/implementation/VOICE-ENROLLMENT-GUIDE.md)에 있습니다.

## 검증 및 배포 현황

현재 문서가 반영하는 버전은 **Mac/iOS 1.4.0, 빌드 12**입니다.

| 항목 | 상태 | 결과 |
| --- | --- | --- |
| Mac 전체 테스트 | 통과 | 397개 통과 |
| iOS 시뮬레이터 전체 테스트 | 통과 | 273개 통과 |
...
| 1.4.0 빌드 12 Mac Release | 완료 | Release 빌드 통과, 코드서명 검증, `/Applications/AI-NoteTaker.app` 설치 및 실행 확인 |
| 1.4.0 빌드 12 iOS Release | 완료 | Release 빌드 통과, IPA `build/releases/AI-NoteTaker-iOS-1.4.0-build12.ipa` 생성과 버전 검증, 실제 iPhone 설치 완료 |
...
| iPhone 설치 | 완료 | 1.4.0 빌드 12 설치 완료 |
