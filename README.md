...
현재 버전은 **Mac 1.7.3 (빌드 22), iOS 1.7.2 (빌드 25)**입니다. 공유 링크는 창을 다시 열거나 앱을 재시작해도 주소와 복사 버튼이 유지됩니다. [공유 주소 복원](docs/implementation/PERSISTENT-WEB-SHARING.md) · [확대 파형 설명](docs/implementation/FOCUSED-WAVEFORM.md)
