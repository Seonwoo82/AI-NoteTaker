...
현재 버전은 **Mac 1.7.3 (빌드 22), iOS 1.7.3 (빌드 26)**입니다. iPhone에서 녹음 시작 직후 종료되던 문제와 빈 녹음 저장을 수정했습니다. [iPhone 녹음 수정](docs/implementation/IOS-RECORDING-START-REPAIR.md) · [공유 주소 복원](docs/implementation/PERSISTENT-WEB-SHARING.md) · [확대 파형 설명](docs/implementation/FOCUSED-WAVEFORM.md)
...
iPhone의 녹음 바는 시간·목소리 상태와 일시정지·완료 버튼을 두 영역으로 표시합니다. 작은 화면이나 큰 글자 설정에서는 필요한 부분만 세로로 전환해 버튼 제목이 잘리지 않도록 합니다. [녹음 바 개선 기록](docs/implementation/IOS-RECORDING-BAR-LAYOUT.md)
...
- Mac 1.6.0 빌드 17과 iPhone 1.6.1 빌드 18 설치·실행을 확인했습니다. 실제 iPhone 목소리 등록은 사용자 확인을 기다립니다. 개인 목소리 등록 데이터는 전송하거나 대신 녹음하지 않았습니다. 자세한 내용은 [목소리 등록 검증 기록](docs/implementation/VOICE-ENROLLMENT-GUIDE.md)에 있습니다.

## 검증 및 배포 현황

현재 문서가 반영하는 버전은 **Mac 1.6.0 (17), iOS 1.6.1 (18)**입니다.
...
| 1.6.1 빌드 18 iOS Release | 완료 | Release 빌드·서명·기기 설치 버전·실행 확인, 녹음 바 10개 상태/크기 정적 렌더 |
...
| iPhone 설치 | 완료 | 1.6.1 빌드 18 설치 및 실행 확인 |
